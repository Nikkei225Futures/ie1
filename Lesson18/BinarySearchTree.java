public class BinarySearchTree {
    ...
    public void printTreePreOrder(){
        System.out.println(getPreOrderTree(this.root));
    }

    private String getPreOrderTree(MyNode localNode){
        if(localNode == null){
            return "";
        }
        ...
        MyNode currentNode = localNode;
        MyNode parentNode = localNode;
        END:while(true){
            if(currentNode.getLeft() == null){
                while(this.getParentNode(currentNode).getRight() == null){
            ...
            str.append(this.getPreOrderTree(currentNode.getLeft()));
            str.append("\n");
            currentNode = currentNode.getLeft();
        }
    }
    ...
    private String getPostOrderTree(MyNode localNode){
        return "";
    }
    
    public void printTreeDesc(){
        System.out.println(this.getDescTree(this.root));
    }

    private String getDescTree(MyNode localNode){
        if(localNode == null){
            return "";
        }

        StringBuffer str = new StringBuffer();
        str.append(this.getDescTree(localNode.getRight()));
        str.append(localNode.getData() + "\n");
        str.append(this.getDescTree(localNode.getLeft()));
        return str.toString();
    }

    private MyNode getParentNode(MyNode localNode){
        MyNode currentNode = this.root;
        MyNode parentNode = this.root;
        while (currentNode.getData().compareTo(currentNode.getData()) != 0) {
            parentNode = currentNode;
            if (currentNode.getData().compareTo(currentNode.getData()) > 0) {
                currentNode = currentNode.getLeft();
            } else {
                currentNode = currentNode.getRight();
            }
