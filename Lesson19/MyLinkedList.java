public class MyLinkedList {
    ...
    public boolean append(Object obj){
        if(this.insert(this.size+1, obj)){
            return true;
        }else{
            return false;
        }
    ...
    //Lesson14_4
    public boolean insertList(MyLinkedList list, int index){
        if(list.size == 0){
            System.out.println("Cannot insert list: insert list is empty");
            return false;
        }else if(list.size < 1 || index > this.getLength() || index < 1){
